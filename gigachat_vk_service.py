...
class GigaChatVKService:
    ...
    def _create_dialog_prompt(self, user_message: str, history: Dict) -> str:
        ...
        ВАЖНОЕ ПРАВИЛО:
        Отвечай ТОЛЬКО на вопросы, связанные с эмоциональным состоянием, психологическим здоровьем, 
        физическим самочувствием, стрессом, усталостью, выгоранием, сном, мотивацией и работой.
        
        ЕСЛИ ВОПРОС НЕ ПО ТЕМЕ (политика, религия, спорт, погода, программирование, математика, 
        новости, развлечения, кулинария, бытовые вопросы и т.д.) - просто напиши:
        "Извините, я отвечаю только на вопросы об эмоциональном и физическом состоянии. 
